...
/**
*  This file was automatically generated by EvoMaster on 2026-03-04T15:33:12.807013021+08:00[Asia/Shanghai]
 * <br>
...
*  
*/
public class EM_features_service_False_6_Test {

    
    private static final SutHandler controller = new em.external.org.javiermf.features.ExternalEvoMasterController(extractSutJarNameWithEnvVarName("WFD_DIST_DIR", "features-service-sut.jar")).setJaCoCo("/home/server/workspace/SCY/MicroService/Dataset/jacoco/jacocoagent.jar","/home/server/workspace/SCY/MicroService/Dataset/jacoco/jacococli.jar","/home/server/workspace/SCY/MicroService/Dataset/exec/features-service__wbEnabledFlakiness__10140__jacoco.exec",8899).setJavaCommand(extractJDKPathWithEnvVarName("JAVA_HOME_8"));
    ...
    */
    ...
    public void test_1_getOnProductCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/products/_EM_13_XYZ_")
                .then()
    ...
    */
    ...
    public void test_2_deleteOnProductCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                ...
                .delete(baseUrlOfSut + "/products/_EM_15_XYZ_")
                .then()
                .statusCode(500)// org/javiermf/features/daos/ProductsDAO_41_findByName
                .assertThat()
                .contentType("text/html");
    ...
    */
    ...
    public void test_4_getOnProductFeaturesCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .get(baseUrlOfSut + "/products/_EM_11_XYZ_/features")
                .then()
                .statusCode(500)// org/javiermf/features/daos/ProductsDAO_41_findByName
                .assertThat()
                .contentType("text/html");
    ...
    */
    ...
    public void test_5_getOnConfigurationsReturnsEmptyList() throws Exception {
        ...
        given().accept("application/json")
                .header("x-EMextraHeader123", "")
                .get(baseUrlOfSut + "/products/_EM_9_XYZ_/configurations")
                .then()
                .statusCode(200)
                .assertThat()
    ...
    */
    @Test(timeout = 60000)
    public void test_6_postOnExcludesCauses500_internalServerError() throws Exception {
    ...
    */
    ...
    public void test_7_postOnConfigurCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .post(baseUrlOfSut + "/products/DSg/configurations/2irC6C6?EMextraParam123=42")
                .then()
                .statusCode(500)// org/javiermf/features/daos/ProductsDAO_41_findByName
                .assertThat()
                .contentType("text/html");
    ...
    */
    ...
    public void test_8_postOnProductFeaturWithQueryParamCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                ...
                .contentType("application/x-www-form-urlencoded")
                .body("")
                .post(baseUrlOfSut + "/products/nqPVYPPmKFHMgYM/features/_EM_21_XYZ_?EMextraParam123=42")
                .then()
                .statusCode(500)// org/javiermf/features/daos/ProductsDAO_41_findByName
                .assertThat()
                .contentType("text/html");
    ...
    */
    ...
    public void test_9_postOnRequiresCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                ...
                .contentType("application/x-www-form-urlencoded")
                .body("")
                .post(baseUrlOfSut + "/products/_EM_26_XYZ_/constraints/requires")
                .then()
                .statusCode(500)// org/javiermf/features/daos/ProductsDAO_41_findByName
                .assertThat()
                .contentType("text/html");
    ...
    */
    ...
    public void test_10_deleteOnConfigurCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                ...
                .delete(baseUrlOfSut + "/products/_EM_5_XYZ_/configurations/jin")
                .then()
    ...
    */
    @Test(timeout = 60000)
    public void test_11_deleteOnProductFeaturCauses500_internalServerError() throws Exception {
        
        // Fault100. HTTP Status 500. org/javiermf/features/daos/ProductsDAO_41_findByName
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .delete(baseUrlOfSut + "/products/fNNoKR9MrU6_7/features/_EM_7_XYZ_")
                .then()
                .statusCode(500)// org/javiermf/features/daos/ProductsDAO_41_findByName
                .assertThat()
                .contentType("text/html");
    ...
    */
    ...
    public void test_12_getOnConfigurReturns204() throws Exception {
        ...
        given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/products/5Mr9nQeHXGa9/configurations/oHXcZRoV5?EMextraParam123=42")
                .then()
                .statusCode(204)
                .assertThat()
                .body(isEmptyOrNullString());
    ...
    */
    ...
    public void test_13_deleteOnConstraintReturns204() throws Exception {
        ...
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .delete(baseUrlOfSut + "/products/E8bGXL/constraints/189?EMextraParam123=_EM_8_XYZ_")
                .then()
                .statusCode(204)
                .assertThat()
                .body(isEmptyOrNullString());
    ...
    */
    ...
    public void test_14_getOnConfigurFeaturesWithQueryParamCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/products/itvxyUF04mci/configurations/X8xNpE/features?EMextraParam123=_EM_2_XYZ_")
                .then()
    ...
    */
    ...
    public void test_15_postOnConfigurFeaturCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .post(baseUrlOfSut + "/products/ltKZKTvQ/configurations/N0eM/features/wr")
                .then()
    ...
    */
    ...
    public void test_16_deleteOnConfigurFeaturCauses500_internalServerError() throws Exception {
        ...
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .delete(baseUrlOfSut + "/products/Yh9xM6cH9dF8/configurations/gWGgIdw3lQX7ho1/features/7x63grVTnD")
                .then()
